...
\thesistitle{Reynolds Numbers  Based Sampling Techniques for 3D Vector Fields in Computation Fluid Dynamic Environments} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
$L$ & characteristic linear demension  & \si{\meter}  \\
