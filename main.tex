...
\thesistitle{A Reynolds Number Based Sampling Technique for 3-D Vector Fields in Computational Fluid Dynamic Environments} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\university{\href{http://www.umt.edu}{University of Montana}} % Your university's name and URL, this is used in the title page and abstract, print it elsewhere with \univname
\department{\href{http://cs.umt.edu}{Department of Computer Science} }% Your department's name and URL, this is used in the title page and abstract, print it elsewhere with \deptname
...
{\LARGE \bfseries \MakeUppercase \ttitle\par}\vspace{0.4cm} % Thesis title
 % Horizontal line
...
\textit{Bachelor of Science - Health \& Human Performance, University of Montana, Missoula, MT, 2015}\\ % University requirement text
\textit{Associates of Applied Science - Photographic Communications, Northwest College, Powell, WY, 2009}\\ % University requirement text
\vfill
...
\dedicatory{Dedicated to my wife without her I would forget to eat. } 
